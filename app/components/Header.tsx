        ...
        <div className="hidden lg:flex items-center gap-4 ml-6">
          <div className="relative group">
            ...
            <input 
              ...
              className="pl-9 pr-12 py-2 bg-white border-2 border-slate-900 rounded-xl text-[12px] font-black text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all w-64 shadow-sm"
            />
            <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1 px-1.5 py-0.5 rounded border border-slate-900 bg-slate-100 text-[10px] text-slate-900 font-black uppercase tracking-tighter">
              {modifierKey} K
            </div>
          </div>
